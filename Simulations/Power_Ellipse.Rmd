...
in the Presence of Various Geometric Misalignments - Power Computation Ellipse"
...
\textbf{Description: This code snippet intakes two Ellipse images and outputs the power of the test described in Section $4.2$ of the manuscript, where the test treats the first image as null $(H_0)$ and the second image as alternate $(H_1)$. More precisely, this particular demonstration computes the power of the test $g_{E,0}$ vs $g_{E,2}^{(H_1)}$}. 
...
## Null and Alternate Ellipses
\textbf{Null Ellipse: $g_{E,0}$, Alternate Ellipse: $g_{E,2}^{(H_1)}$}
```{r, echo=TRUE, cache=TRUE}
