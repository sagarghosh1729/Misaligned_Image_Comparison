...
in the Presence of Various Geometric Misalignments - Power Computation Amoeba"
...
\textbf{Description: This code snippet intakes two Amoeba images and outputs the power of the test
described in Section $4.2$ of the manuscript, where the test treats the first image as null ($H_0$) and
the second image as alternate ($H_1$). More precisely, this particular demonstration computes
the power of the test $g_{A,0}$ vs $g_{A,2}^{(H_1)}$}. 
...
## Null and Alternate Amoeba
\textbf{Null Amoeba: $g_{A,0}$, Alternate Amoeba: $g_{A,2}^{(H_1)}$}
```{r, echo=TRUE, cache=TRUE}
