...
in the Presence of Various Geometric Misalignments - Local Change Detection"
...
\textbf{Description: This code snippet intakes two image paths and outputs the position on the second image where the maximal change has happened compared to the first image}
